...
export const useKgbStore = defineStore("kgb", {
  ...
  actions: {
    async getData(page = "") {
      ...
      try {
        const response = await axiosIns.get(
          `/kgb?limit=${this.currentLimit}${this.searchQuery}${page}${this.dateQuery}`
        );
    ...
    async store() {
      ...
      try {
        const response = await axiosIns.post(`/kgb`, this.form);
