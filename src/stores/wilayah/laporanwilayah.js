...
export const useLaporanWilayahStore = defineStore("laporan", {
  ...
  actions: {
    ...
    async store() {
      ...
      try {
        const response = await axiosIns.post(`/laporan-wilayah`, this.form);
    ...
    async destroy(id) {
      ...
      setTimeout(() => {}, 500);
      try {
        await axiosIns.delete(`/laporan-wilayah/${id}`);
    ...
    async update() {
      ...
      try {
        const response = await axiosIns.put(
          `/laporan-wilayah/${this.singleResponses.id}`,
    ...
    async download(label, id) {
      ...
      try {
        const response = await axiosIns
          .get(`/laporan-wilayah-download/${id}`, {
