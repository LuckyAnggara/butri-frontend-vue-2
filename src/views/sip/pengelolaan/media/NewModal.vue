      ...
      >
        ...
        <form v-if="updateData" @submit.prevent="prosesUpdate()">
          <div class="flex w-full space-x-2">
            <FormField label="Tahun" class="w-full">
              <select
                :disabled="pengelolaanMediaStore.isUpdateLoading"
                v-model="pengelolaanMediaStore.singleResponses.tahun"
            ...
            <FormField label="Bulan" class="w-full">
              <select
                :disabled="pengelolaanMediaStore.isUpdateLoading"
                v-model="pengelolaanMediaStore.singleResponses.bulan"
                class="h-12 border px-3 py-2 max-w-full focus:ring focus:outline-none border-gray-700 rounded w-full dark:placeholder-gray-400 bg-white dark:bg-slate-800"
              >
                <option
          ...
          <FormField label="Jenis">
            <select
              :disabled="pengelolaanMediaStore.isUpdateLoading"
              v-model="pengelolaanMediaStore.singleResponses.type"
              required
              class="h-12 border px-3 py-2 max-w-full focus:ring focus:outline-none border-gray-700 rounded w-full dark:placeholder-gray-400 bg-white dark:bg-slate-800"
            >
              <option
                v-for="option in mainStore.jenisMediaOptions"
                :key="option"
                :value="option"
              >
                {{ option }}
          ...
          <FormField label="Keterangan">
            <FormControl
              type="textarea"
              required
              v-model="pengelolaanMediaStore.singleResponses.keterangan"
              :disabled="pengelolaanMediaStore.isUpdateLoading"
          ...
          <FormField label="Link">
            <FormControl
              type="textarea"
              required
              v-model="pengelolaanMediaStore.singleResponses.link"
              :disabled="pengelolaanMediaStore.isUpdateLoading"
              placeholder="Link konten jika ada"
            />
          </FormField>
          ...
          <div class="flex justify-start space-x-3 items-center">
            <BaseButton
              ...
              type="submit"
              color="info"
              ><span v-if="!pengelolaanMediaStore.isUpdateLoading"
        ...
        <form v-else @submit.prevent="prosesRequest()">
          <div class="flex w-full space-x-2">
            <FormField label="Tahun" class="w-full">
              <select
                :disabled="pengelolaanMediaStore.isStoreLoading"
                v-model="pengelolaanMediaStore.form.tahun"
                class="h-12 border px-3 py-2 max-w-full focus:ring focus:outline-none border-gray-700 rounded w-full dark:placeholder-gray-400 bg-white dark:bg-slate-800"
              >
                <option
                  v-for="option in mainStore.tahunOptions"
            ...
            <FormField label="Bulan" class="w-full">
              <select
                :disabled="pengelolaanMediaStore.isStoreLoading"
                v-model="pengelolaanMediaStore.form.bulan"
                class="h-12 border px-3 py-2 max-w-full focus:ring focus:outline-none border-gray-700 rounded w-full dark:placeholder-gray-400 bg-white dark:bg-slate-800"
              >
                <option
                  v-for="option in mainStore.bulanOptions"
          ...
          <FormField label="Jenis">
            <select
              :disabled="pengelolaanMediaStore.isStoreLoading"
              v-model="pengelolaanMediaStore.form.type"
              required
              class="h-12 border px-3 py-2 max-w-full focus:ring focus:outline-none border-gray-700 rounded w-full dark:placeholder-gray-400 bg-white dark:bg-slate-800"
            >
              <option
          ...
          <FormField label="Keterangan">
            <FormControl
              type="textarea"
              required
              v-model="pengelolaanMediaStore.form.keterangan"
              :disabled="pengelolaanMediaStore.isStoreLoading"
              placeholder="Nama / Judul Konten"
            />
          </FormField>
          <FormField label="Link">
            <FormControl
              type="textarea"
              required
              v-model="pengelolaanMediaStore.form.link"
              :disabled="pengelolaanMediaStore.isStoreLoading"
              placeholder="Link konten jika ada"
            />
          </FormField>
          ...
          <div class="flex justify-start space-x-3 items-center">
            <BaseButton
              ...
              type="submit"
              color="info"
              ><span v-if="!pengelolaanMediaStore.isStoreLoading">Submit</span
              ><span class="flex flex-row items-center" v-else>
                <ArrowPathIcon class="h-5 w-5 animate-spin mr-3" />
                Processing</span
              ></BaseButton
